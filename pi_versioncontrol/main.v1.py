...
# transceiver = serial.Serial('/dev/ttyUSB1', 115200, timeout=1)
...
while True:
    ...
    if GPIO.input(7) == GPIO.HIGH:
        ...
        line = ('{0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}, {8}' .format(current_time, arduino_readings.data.wheel_left, arduino_readings.data.wheel_right, arduino_readings.data.wheel_centre, arduino_readings.data.gear, arduino_readings.data.Temperature, arduino_readings.data.Humidity, arduino_readings.data.Pressure,arduino_readings.data.Total_Speed))
...
#         
       ...
       #////////////////////////////////////////////////////////////////////////////
        ...
        cadance = float(arduino_readings.data.wheel_centre)  * gearratio[arduino_readings.data.gear-1]
        ...
        z = ' Cadance: ' +Cam_cadance +     ' RPM: ' + str(arduino_readings.data.wheel_centre) +'                            '+ str(distance)
        ...
        camera.annotate_text = z
               ...
               #camera.annotate_test = j
            
       #s = "This message would be far too long to display normally..."
       #camera.annotate_text = ' ' * 65
       #for c in itertools.cycle(s):
       #camera.annotate_text = camera.annotate_text[1:65] + c
       #   time.sleep(0.03)
